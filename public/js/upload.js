...
function viewAlbum(albumName) {
  ...
  s3.listObjects({ Prefix: albumPhotosKey }, function (err, data) {
    ...
    var htmlTemplate = [
      ...
      '<label for="colFormLabelSm" class="galada-fnt col-sm-2 col-form-label col-form-label-sm">Add a Category:</label>',
      '<div class="col-xs-4">',
      '<input type="string" class="form-control form-control-sm" id="colFormLabelSm" placeholder="">',
      '</div>',
      '</div>',
